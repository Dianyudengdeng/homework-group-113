...
**主要做的工作**：实现ECDSA，Schnorr，SM2签名，验签算法；
提供以下漏洞的概念验证代码  
- Leaking k leads to leaking of d: ECDSA、Schnorr、SM2-sig  
- Reusing k leads to leaking of d: ECDSA、Schnorr、SM2-sig  
- Reusing k by different users leads to leaking of d: ECDSA、Schnorr、SM2-sig  
- (r,s) and (r,-s)are both valid signatures: ECDSA、Schnorr  
